...
public:
    ...
    // std::vector<MachineBlock*> &getRange(){return rangeCurve;};
    // void recordRange(MachineBlock* no){ rangeCurve.emplace_back(no);};
    bool getRange(){return rangeCurve;};
    void recordRange(bool r){ rangeCurve=r;};
    bool getRange_r(){return rangeCurve_r;};
    void recordRange_r(bool r){ rangeCurve_r=r;};
};
...
protected:
    ...
    void addDef(MachineOperand* ope) { def_list.emplace_back(ope); };
    void addUse(MachineOperand* ope) { use_list.emplace_back(ope); };
...
public:
    ...
    void InsertInst(MachineInstruction* inst) { this->inst_list.emplace_back(inst); };
    void addPred(MachineBlock* p) { this->pred.emplace_back(p); };
    void addSucc(MachineBlock* s) { this->succ.emplace_back(s); };
...
public:
    ...
    * you can use this function in LinearScan::genSpillCode() */
    ...
    void InsertBlock(MachineBlock* block) { this->block_list.emplace_back(block); };
    ...
    bool needAlign() {return align_flag;};
...
public:
    ...
    void InsertFunc(MachineFunction* func) { func_list.emplace_back(func);};
    void output();
